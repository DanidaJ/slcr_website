...
export default function PresidentMessage() {
  return (
    <section className="py-16 sm:py-20 lg:py-24 xl:py-28 bg-navy overflow-hidden">
      <div className="max-w-7xl 2xl:max-w-screen-2xl mx-auto px-5 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-12 xl:gap-16 items-center">
          ...
          <motion.div
            ...
            whileInView="visible"
            viewport={VIEWPORT}
            className="text-white order-2 lg:order-none"
          >
            <p className="text-white/50 text-[11px] sm:text-xs font-semibold tracking-[0.2em] uppercase mb-2">
              Leadership
            </p>
            <h2 className="font-heading text-3xl sm:text-4xl xl:text-5xl font-extrabold tracking-tight mb-3">
              President&apos;s Message
            </h2>
            ...
            {/* Quote block */}
            <div className="relative">
              <span className="absolute -top-5 sm:-top-6 -left-1 sm:-left-2 text-white/10 text-7xl sm:text-9xl font-heading font-extrabold leading-none select-none pointer-events-none">
                &ldquo;
              </span>
              <p className="relative text-white/75 leading-relaxed text-[15px] sm:text-base mb-4 pl-2">
              ...
              <p className="relative text-white/75 leading-relaxed text-[15px] sm:text-base pl-2">
